...
root= tk.Tk()
root.title("Assignment No. 3 ")
root.geometry("1000x1000")
root.configure(bg='palegreen')
lbl = Label (root, text="   Assignment No 3:DM21G05", justify='center', fg="blue", font="none 20 bold")
lbl.grid(column=0, row=0, sticky=tk.N, padx=10, pady=10)

y=[220,320,420,520,620,620]
x=[150,150,250,350,350,550]
...
def z_score_norm_x():
	x_z_scaled = x
	x_z_scaled = (x_z_scaled - x_z_scaled[3]) / x_z_scaled.std()
...
insert=Button(root, text="Upload File", command=get_excel, font="none 14 bold")
insert.grid(row=2, column=0, columnspan=2, pady=30, padx=30, ipadx=50)
# canvas1.create_window(430, 100, window=insert)
...
insert=Button(root, text="Min-Max Normalization", command=min_max_norm_x, font="none 14 bold")
insert.grid(row=23 , column=0, columnspan=2, pady=20, padx=20, ipadx=25)

insert=Button(root, text="Z-Score Normalization", command=z_score_norm_x, font="none 14 bold")
insert.grid(row=23 , column=3, columnspan=2, pady=20, padx=20, ipadx=25)

insert=Button(root, text="Decimal Normalization", command=dec_scale_norm_x, font="none 14 bold")
